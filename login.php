...
<html xmlns="http://www.w3.org/1999/xhtml" lang="Pt-br">
    ...
    <body style="padding:10px">
        ...
        <table cellpadding="1" cellspacing="10"  width="900" align="center"  border="1">

            <tr>
                <td colspan="11" align="center" >
                    Faça Login para entrar no
            ...
            <table cellpadding="5" cellspacing="0" width="900" align="center">
                <tr>
                    <td align="right">
                        <hr size="1" />
                        <em>Livro Caixa - <strong><?php echo $lc_titulo ?></strong> - Melhorado por <a href=https://github.com/marlondantas target="_blank">Marlon Dantas</a>. Versão 2.0 (13/04/2019)</em>
                    </td>
                </tr>
            </table>
